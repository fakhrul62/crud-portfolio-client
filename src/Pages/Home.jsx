        ...
        <div className="grid lg:grid-cols-3 gap-10 w-10/12 mx-auto">
          <div className="bg-gray-900 border border-gray-800 p-5 rounded-2xl py-10 lg:order-1 order-2">
            ...
            <div className="flex justify-center gap-5 *:text-2xl hover:*:text-accenth">
              <a
                href="https://www.linkedin.com/in/md-fakhrul-alam-shuvo/"
                target="_blank"
              >
                <FaLinkedinIn />
              </a>
            ...
            <div className="mt-10 text-center">
              <a
                href="https://mail.google.com/mail/?view=cm&fs=1&to=ifakhrul23@gmail.com"
                target="_blank"
            ...
            <div className="grid md:grid-cols-3 gap-5 mt-10">
              <div className="p-7 flex flex-col gap-4 text-center rounded-2xl border border-gray-800 bg-gray-900">
                <h3 className="font-heading font-bold text-3xl">
                  24 <span className="text-accent">+</span>
                </h3>
                <p className="font-body lg:text-sm text-xs uppercase tracking-widest">
                  Projects Completed
                </p>
              </div>
              <div className="p-7 flex flex-col gap-4 text-center rounded-2xl border border-gray-800 bg-gray-900">
